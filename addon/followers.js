      ...
      elements.forEach((element) => {
        ...
        if (hasMatch && !element.dataset.scanLinkAdded) {
          ...
          if (linkElement) {
            ...
            const targetElement = element.querySelector('.css-18t94o4.css-1dbjc4n.r-1m3jxhj.r-42olwf.r-sdzlij.r-1phboty.r-rs99b7.r-15ysp7h.r-4wgw6l.r-1ny4l3l.r-ymttw5.r-o7ynqc.r-6416eg.r-lrvibr');
            if (targetElement) {
